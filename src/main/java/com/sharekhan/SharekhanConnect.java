...
private Routes routes = new Routes();
	...
	public String getLoginURL(String apiKey,String vendor_key,String version_id,Long state) throws NullPointerException {
	...
	public JSONObject generateSession( String apiKey,String request_Token,String vendor_key, Long state,String secretKey,Long version_id) {
		try {
...
//		byte[] original = null;
	...
	public JSONObject generateSessionWithoutVersionId( String apiKey,String request_Token,String vendor_key, Long state,String secretKey) {
		try {
