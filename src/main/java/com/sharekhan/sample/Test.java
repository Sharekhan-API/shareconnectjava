...
public class Test {
	...
	public static void main(String[] args) throws SharekhanAPIException {
		...
		String vendorKey = "enter-vendor-key";
		
		try {
			SharekhanConnect sharekhanConnect = new SharekhanConnect(vendorKey,apiKey,accessToken);
...
//			examples.sharekhanWebSocketUsage(accessToken,apiKey);
